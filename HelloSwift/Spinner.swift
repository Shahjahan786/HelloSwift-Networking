...
//  AlfaMerchant
//
//  Created by Shahjahan Samoon on 02/11/2018.
//  Copyright © 2018 Bank Alfalah. All rights reserved.
//
...
final class Spinner {
    ...
    fileprivate static var baseBackColor = UIColor(white: 0, alpha: 0)
    fileprivate static var baseColor = UIColor.blue
